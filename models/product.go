...
type Product struct {
	...
	SKU        uint64    `json:"sku" xml:"sku" form:"sku" query:"sku" gorm:"type:varchar(255)"`
	CategoryId string    `json:"category_id" xml:"category_id" form:"category_id" query:"category_id" gorm:"type:varchar(255);NOT NULL;index"`
